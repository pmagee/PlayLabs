...
public class HomeController extends Controller {
    ...
    public Result onsale(Long cat) {
        ...
        public Result about() {
            ...
            public Result emergency() {
                /*CORRECTED*/
                    return ok(emergency.render(User.getUserById(session().get("email"))));
                }

                public Result closing() {
                    /*CORRECTED*/
                        return ok(closing.render(User.getUserById(session().get("email"))));
                    }
                    ...
                    // Personal Note - James: I know we didn't have to add in the commentary
                    // but I felt typing it would help me retain the information better, so
                    // I did it anyway 
